...
export const can = {
  ...
  verPermisos:             (u) => hasRole(u, ROLES.ADMIN),
  verUnidadRequiriente:   (u) => hasRole(u, OPERATIVOS),
  verPresupuesto:          (u) => hasRole(u, OPERATIVOS),
  exportarTodosReportes:   (u) => hasRole(u, [ROLES.DIRECTOR, ROLES.RECTOR, ROLES.ADMIN]),

  // Certificaciones — ver módulo controlado por RBAC (permiso 'ver')
  ...
  editarCertificacion:     (u) => permiso(u, 'certificaciones', 'editar',   () => hasRole(u, OPERATIVOS)),
  ...
  // Liquidaciones — ver módulo controlado por RBAC (permiso 'ver')
