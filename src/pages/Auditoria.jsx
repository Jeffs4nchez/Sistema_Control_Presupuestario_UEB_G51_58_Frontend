  ...
  return (
    <motion.button
      ...
      style={{
        ...
        background: active ? _ACCENT : 'rgba(255,255,255,0.90)',
        color: active ? '#fff' : disabled ? _MUTED : _TEXT,
        border: active ? `1px solid ${_ACCENT}` : '1px solid rgba(46,108,164,0.14)',
